...
const EnhancedLotteryCard = dynamic(
  () =>
    import('@/components/lottery/enhanced-lottery-card').then(
      mod => mod.EnhancedLotteryCard
    ),
  {
    loading: () => (
...
export default function DashboardPage() {
  ...
  const netPositionRef = useCountUp(
    Math.abs(userBalance.netPosition),
    ...
    <PageContainer>
      ...
      {userDataError && (
        <Alert variant='destructive' className='mb-8'>
          ...
          <AlertDescription>
            {userDataError?.message || 'Unknown error occurred'}
          </AlertDescription>
        </Alert>
      )}
          ...
          <div className='grid grid-cols-4 gap-16'>
            ...
            <div>
              ...
              <div className='text-xl font-light text-gray-600 font-mono'>
                {userDataLoading
                  ? '—'
                  : `$${userStats.pendingWinnings.toFixed(2)}`}
              </div>
