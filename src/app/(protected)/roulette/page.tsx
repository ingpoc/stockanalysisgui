      ...
      {activeGame && process.env.NODE_ENV === 'development' && (
        <div className='mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
          <div className='flex items-center justify-between'>
            ...
            <button
              onClick={() => toast.error('Automation disabled for security', { description: 'Automation is now handled by backend services only.' })}
              disabled={true}
              ...
              title="Automation moved to backend services for security"
            >
              AUTOMATION DISABLED
            </button>
          </div>
