...
export function InitializeProgramDialog({ open, onOpenChange }: InitializeProgramDialogProps) {
  ...
  const [isCheckingInitialization, setIsCheckingInitialization] = useState(false)
        ...
        {isCheckingInitialization ? (
          ...
          <div className="py-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
              <div className="text-green-600 font-medium">✅ Program Already Initialized</div>
              <div className="text-green-700 mt-2 text-sm">
                The lottery program has been successfully initialized. You can now proceed to create lotteries.
              </div>
            </div>
