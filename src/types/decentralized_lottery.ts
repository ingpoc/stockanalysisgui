...
export type DecentralizedLottery = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [52, 205, 208, 34, 155, 130, 12, 18];
      accounts: [
        {
          name: 'lotteryAccount';
          writable: true;
  ...
  accounts: [
    ...
    {
      name: 'lotteryAccount';
      discriminator: [1, 165, 125, 59, 215, 12, 246, 7];
    },
    {
      name: 'ticketAccount';
  ...
  events: [
    {
      name: 'drawingStarted';
      discriminator: [105, 108, 34, 253, 27, 204, 35, 5];
    },
    {
      name: 'lotteryCreated';
      discriminator: [162, 18, 70, 148, 241, 124, 57, 74];
    },
    {
      name: 'lotteryStateChanged';
      discriminator: [116, 62, 184, 135, 124, 90, 153, 26];
    },
    {
      name: 'lotteryWinnerDetermined';
      discriminator: [110, 172, 60, 137, 146, 76, 59, 123];
    },
    {
      name: 'prizeClaimed';
    ...
    },
    {
      ...
      discriminator: [90, 36, 18, 118, 153, 234, 93, 144];
    },
    {
      name: 'randomnessRequested';
      discriminator: [10, 64, 183, 29, 104, 63, 90, 149];
    },
    {
      name: 'randomnessSettled';
      discriminator: [219, 235, 45, 239, 116, 19, 92, 74];
    },
    {
    ...
    },
    {
      ...
      discriminator: [0, 118, 216, 155, 30, 123, 193, 166];
    },
    {
      name: 'winnerSelected';
